...
export function parseCreateRequest(value: unknown): ParsedCreateRequest {
  ...
  if (value.scope === "database") {
    if ((value.operation !== "create" && value.operation !== "existing") || value.superuser !== undefined) {
  ...
  if (value.scope === "full" && typeof value.superuser === "boolean" && value.operation === undefined && value.database === undefined) {
    return {
      action: "create-connection",
