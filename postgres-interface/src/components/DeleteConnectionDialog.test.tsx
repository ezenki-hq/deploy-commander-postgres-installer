...
const context: DeleteConnectionApprovalContext = {
  callingManagerId: 'consumer-manager',
  requestedConnectionId: 'connection-1',
  choices: [
    { id: 'connection-1', access: { scope: 'database', operation: 'create', database: 'orders' } },
  ],
};
const ready: ActionGateState<DeleteConnectionApprovalContext> = {
  kind: 'ready',
